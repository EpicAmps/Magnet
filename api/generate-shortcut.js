...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (!fridgeName || !fridgeId) {
      return res
        .status(400)
        .json({ error: "fridgeName and fridgeId are required" });
    }
    ...
    const shortcutActions = [
      ...
      },
      {
        ...
        WFWorkflowActionParameters: {
          WFHTTPMethod: "POST",
          WFHTTPBodyType: "JSON",
          WFURL: "https://magnet-mu.vercel.app/api/webhook",
          WFJSONValues: {
            Value: {
    ...
    res.status(200).json({
      ...
      instructions: [
        ...
        "6. The shortcut will appear in your share sheet as 'Send to " +
          fridgeName +
          "'",
      ],
    });
